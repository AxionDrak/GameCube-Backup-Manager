...
public partial class frmBurnMedia : Form
{
    ...
    private void frmBurnMedia_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (!discMaster.IsSupportedEnvironment) return;
        ...
        {
            if (discMaster != null) _ = Marshal.ReleaseComObject(discMaster);
        }
    ...
    private readonly BurnData _burnData = new();
    ...
    private void cbDevices_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            foreach (IMAPI_PROFILE_TYPE profileType in discRecorder.SupportedProfiles)
            {
                ...
                if (supportedMediaTypes.Length > 0) _ = supportedMediaTypes.Append(", ");
        ...
        {
            if (discFormatData != null) _ = Marshal.ReleaseComObject(discFormatData);
        }
    }
    ...
    private void btnDetectMedia_Click(object sender, EventArgs e)
    {
        ...
        finally
        {
            ...
            if (fileSystemImage != null) _ = Marshal.ReleaseComObject(fileSystemImage);
        }
    ...
    private void bgBurnWorker_DoWork(object sender, DoWorkEventArgs e)
    {
        ...
        try
        {
            ...
            //
            if (!CreateMediaFileSystem(discRecorder, multisessionInterfaces, out var fileSystem))
            {
                e.Result = -1;
                return;
            }
            ...
            {
                if (fileSystem != null) _ = Marshal.FinalReleaseComObject(fileSystem);
            }
        ...
        {
            if (discRecorder != null) _ = Marshal.ReleaseComObject(discRecorder);
    ...
    private void bgFormatWorker_DoWork(object sender, DoWorkEventArgs e)
    {
        ...
        finally
        {
            ...
            if (discFormatErase != null) _ = Marshal.ReleaseComObject(discFormatErase);
        }
    }
